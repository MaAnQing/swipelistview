...
import com.huami.madroid.swipelistview.SlideCutListView.RemoveDirection;
import com.huami.madroid.swipelistview.SlideCutListView.RemoveListener;
...
public class SlideCutActivity extends Activity implements RemoveListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cutlist);
        init();
    }
    private void init() {
